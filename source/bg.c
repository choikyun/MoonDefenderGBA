 ...
 ***************************************************/
void
load_bg_bitmap (const u16 *data, int len)
{
  u16 *screen = (u16 *) VRAM;
 ...
 ***************************************************/
void
load_bg_bitmap_fast (const u16 *data, int len)
{
  u16 *screen = (u16 *) VRAM;
 ...
 ***************************************************/
void
draw_bitmap16 (int x, int y, int w, int h, const u16 *data, u16 trans)
{
  int i, j;
 ...
 ***************************************************/
void
save_bitmap16 (int x, int y, int w, int h, u16 *data)
{
  int i, j;
  u16 *screen = (u16 *) VRAM + y * SCREEN_WIDTH + x;
 ...
 ***************************************************/
void
load_bitmap16 (int x, int y, int w, int h, u16 *data)
{
  int i, j;
  u16 *screen = (u16 *) VRAM + y * SCREEN_WIDTH + x;
 ...
 ***************************************************/
void
draw_bitmap8 (int x, int y, int w, int h, const u16 *data)
{
 ...
 ***************************************************/
void
draw_bitmap_frame (int x, int y, int w, int h, const u16 *data)
{
 ...
 ***************************************************/
void
load_frame_bitmap_lz77 (const u16 *data)
{
 ...
 ***************************************************/
void
load_frame_bitmap(const u16 *data)
{
 ...
 ***************************************************/
void
fill_frame_bitmap(const u8 *color)
{
